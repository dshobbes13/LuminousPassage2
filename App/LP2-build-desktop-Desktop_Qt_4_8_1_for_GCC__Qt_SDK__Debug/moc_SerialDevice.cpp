/****************************************************************************
** Meta object code from reading C++ file 'SerialDevice.h'
**
...
#include "../LP2/SerialDevice.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SerialDevice.h' doesn't include <QObject>."
...
const QMetaObject cSerialDevice::staticMetaObject = {
    { &iSequentialDevice::staticMetaObject, qt_meta_stringdata_cSerialDevice,
...
void *cSerialDevice::qt_metacast(const char *_clname)
{
    ...
    return iSequentialDevice::qt_metacast(_clname);
}

int cSerialDevice::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = iSequentialDevice::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
